...
const PropertiesDetails = ({ property, onClose }) => {
                ...
                <div className="mb-6">
                    ...
                    <p className="text-gray-600 leading-relaxed">
                        {property.description ||
                            `This beautiful property located in ${
                                property.location
                            } offers ${
                                property.size
                            } square feet of comfortable living space. Perfect for individuals or families looking for a cozy place in a great neighborhood. The property includes ${
                                property.bathrooms
                            } ${
